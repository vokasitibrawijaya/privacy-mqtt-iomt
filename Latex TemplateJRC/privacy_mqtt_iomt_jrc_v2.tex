...
\author{Rachmad Andri Atmoko \textsuperscript{1}, Salnan Ratih Asriningtias \textsuperscript{1*}, Akas Bagus Setiawan \textsuperscript{2},\\ Devasis Pradhan \textsuperscript{3}, Ismail Rakip Karas \textsuperscript{4}\\
...
\textsuperscript{3} ECE Department, Acharya Institute of Technology, India \\
\textsuperscript{4} Computer Engineering Department, Karab\"{u}k University, Demir Celik Campus, 78050 Karab\"{u}k, Turkey \\
Email: \textsuperscript{1} ra.atmoko@ub.ac.id, salnan@ub.ac.id, \textsuperscript{2} akasbagus\_s@polije.ac.id,\\ \textsuperscript{3} devasispradhan@acharya.ac.in, \textsuperscript{4} ismail.karas@karabuk.edu.tr\\
